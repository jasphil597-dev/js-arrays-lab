...
//Ref: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array#copying_methods_and_mutating_methods
...
//  Ref: https://stackoverflow.com/questions/64437674/how-to-nest-a-foreach-in-a-foreach-to-get-sum-for-javascript

let total = 0; // 2.

numArrays.forEach((insideArray) => {
	insideArray.forEach((sum) => {
		total += sum;
	});
});
